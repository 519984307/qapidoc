...
class Q_API_DOC_EXPORT PathOperation : public ObjectMapper
{
    ...
    //!
    Q_PROPERTY(QString operation READ operationObject WRITE setOperation RESET resetOperation NOTIFY
                   operationChanged)
    ...
    //!
    Q_PROPERTY(QString operationId READ operationId WRITE setOperationId RESET resetOperationId
                   NOTIFY operationIdChanged)
    ...
    Q_PROPERTY(bool deprecated READ deprecated WRITE setDeprecated RESET resetDeprecated NOTIFY
                   deprecatedChanged)
    ...
    Q_PROPERTY(QStringList consumes READ consumes WRITE setConsumes RESET resetConsumes NOTIFY
                   consumesChanged)

    //! A list of MIME types the operation can produce. This overrides the produces definition at the Swagger Object.
    //! An empty value MAY be used to clear the global definition. Value MUST be as described under Mime Types.
    Q_PROPERTY(QStringList produces READ produces WRITE setProduces RESET resetProduces NOTIFY
                   producesChanged)
    ...
    Q_PROPERTY(QVariantHash responses READ responsesObject WRITE setResponses RESET resetResponses
                   NOTIFY responsesChanged)
    ...
    Q_PROPERTY(QVariantList security READ security WRITE setSecurity RESET resetSecurity NOTIFY
                   securityChanged)
