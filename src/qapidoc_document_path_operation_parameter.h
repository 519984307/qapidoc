...
class Q_API_DOC_EXPORT Parameter : public ObjectMapper
{
    ...
    Q_PROPERTY(QApiParameterInLocation inLocation READ inLocation WRITE setInLocation RESET
                   resetInLocation NOTIFY inLocationChanged)
    ...
    Q_PROPERTY(
        bool required READ required WRITE setRequired RESET resetRequired NOTIFY requiredChanged)
    ...
    Q_PROPERTY(QApiTypeParameter typeParameter READ typeParameter WRITE setTypeParameter RESET
                   resetTypeParameter NOTIFY typeParameterChanged)
    ...
    Q_PROPERTY(QString default READ defaultValue WRITE setDefaultValue RESET resetDefaultValue
                   NOTIFY defaultValueChanged)

    //!
    Q_PROPERTY(QStringList enum READ enumValue WRITE setEnumValue RESET resetEnumValue NOTIFY
                   enumValueChanged)

    //!
    Q_PROPERTY(bool allowEmptyValue READ allowEmptyValue WRITE setAllowEmptyValue RESET
                   resetAllowEmptyValue NOTIFY allowEmptyValueChanged)
