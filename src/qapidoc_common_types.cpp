...
Q_GLOBAL_STATIC_WITH_ARGS(QStringList,
                          staticQApiParameterInLocation,
                          ({"", "query", "header", "path", "formData", "body"}));
Q_GLOBAL_STATIC_WITH_ARGS(
    QStringList,
    staticQApiPathTypeOperationList,
    ({"", "get", "post", "put", "delete", "options", "head", "patch", "trace"}));
Q_GLOBAL_STATIC_WITH_ARGS(QStringList,
                          staticQApiTypeParameter,
                          ({"defined", "string", "number", "int", "boolean", "array", "file"}));
Q_GLOBAL_STATIC_WITH_ARGS(QApiTransferProtocolSchemeList,
                          staticQApiTransferProtocolSchemeList,
                          ({stpsNotDefined, stpsHttp, stpsHttps, stpsWs, stpsWss}));
Q_GLOBAL_STATIC_WITH_ARGS(QApiTransferProtocolSchemeHash,
                          staticQApiTransferProtocolSchemeHash,
                          ({{"", stpsNotDefined},
                            {"null", stpsNotDefined},
...
Q_GLOBAL_STATIC_WITH_ARGS(QApiPathTypeOperationHash,
                          staticQApiPathTypeOperationHash,
                          ({{"", sptoNotDefined},
